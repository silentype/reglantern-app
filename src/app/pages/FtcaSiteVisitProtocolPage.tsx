/** FtcaSiteVisitProtocolPage — Tools > FTCA Site Visit Protocol. Title + description only for now. */
export function FtcaSiteVisitProtocolPage() {
  return (
    <div className="px-[24px] pt-[22px] pb-[16px] border-b border-[#e4e4e7] dark:border-[#2a2f3a]">
      ...
      <p className="text-[13px] text-[#71717a] dark:text-[#a1a1aa] mt-0.5">
        Federal Tort Claims Act deeming site visit checklist.
      </p>
    </div>
  );
}
