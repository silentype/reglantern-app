      ...
      <div className={clsx('relative inline-flex shrink-0', className)}>
        ...
        <input
          ...
          className={clsx(
            ...
            'placeholder:text-[#6b7280] dark:placeholder:text-[#a1a1aa] transition-colors',
        ...
        {showClear && (
          <button
            ...
            className="absolute right-2 top-1/2 -translate-y-1/2 p-0.5 rounded hover:bg-[#e4e4e7] transition-colors focus:outline-none focus-visible:ring-2 focus-visible:ring-[#fc6] focus-visible:ring-offset-1"
          >
