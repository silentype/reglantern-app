import svgPaths from "./svg-seixb76vfm";
...
function UploadFilesContainer() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="Upload Files Container">
      ...
      <p className="col-1 font-['Inter:Bold',sans-serif] font-bold h-[17px] leading-[normal] ml-0 mt-[57px] not-italic relative row-1 text-[#00bc06] text-[14px] text-center w-[517px]">File Uploaded</p>
      <p className="col-1 font-['Inter:Regular',sans-serif] font-normal h-[17px] leading-[normal] ml-0 mt-[85px] not-italic relative row-1 text-[#0d062d] text-[14px] text-center w-[517px]">Name_of_patient_file.pdf</p>
