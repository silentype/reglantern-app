import svgPaths from "./svg-wipmx37iz4";
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Close Button">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Close Button">
          <path clipRule="evenodd" d={svgPaths.p28fcbf80} fill="var(--fill-0, #09090B)" fillRule="evenodd" id="Icon" />
        </g>
      </svg>
    </div>
  );
  ...
  return (
    <div className="content-stretch flex gap-[12px] items-center pl-[8px] relative shrink-0" data-name="Icon">
      <div className="flex flex-col font-['Geist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#18181b] text-[14px] text-right whitespace-nowrap">
        <p className="leading-[20px]">1 of 5 files uploaded</p>
      </div>
      <StatusDropdownIcon1 />
    </div>
  );
...
function Assignee1() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Assignee">
      <div className="flex flex-col font-['Geist:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#00bc06] text-[14px] whitespace-nowrap">
        <p className="leading-[20px]">Uploaded</p>
      </div>
    </div>
  );
}
...
function ActionButton1() {
  return (
    <div className="bg-white col-1 content-stretch flex gap-[8px] h-[40px] items-center ml-[201px] mt-[115px] px-[16px] py-[8px] relative rounded-[6px] row-1" data-name="Action Button">
      <div aria-hidden="true" className="absolute border border-[#cdd7e1] border-solid inset-0 pointer-events-none rounded-[6px]" />
      <div className="flex flex-col font-['Geist:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#18181b] text-[14px] whitespace-nowrap">
        <p className="leading-[20px]">Replace File</p>
      </div>
    </div>
  );
}
...
function UploadFilesContainer() {
  return (
    <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="Upload Files Container">
      <div className="bg-[rgba(0,188,6,0.15)] border border-[#00bc06] border-solid col-1 h-[164px] ml-0 mt-[25px] rounded-[8px] row-1 w-[521px]" data-name="Upload Files Background" />
      <p className="col-1 font-['Inter:Bold',sans-serif] font-bold h-[17px] leading-[normal] ml-0 mt-[57px] not-italic relative row-1 text-[#00bc06] text-[14px] text-center w-[517px] whitespace-pre-wrap">File Uploaded</p>
      <p className="col-1 font-['Inter:Regular',sans-serif] font-normal h-[17px] leading-[normal] ml-0 mt-[85px] not-italic relative row-1 text-[#0d062d] text-[14px] text-center w-[517px] whitespace-pre-wrap">Name_of_patient_file.pdf</p>
      <div className="col-1 flex flex-col font-['Geist:Regular',sans-serif] font-normal justify-center ml-0 mt-0 relative row-1 text-[#09090b] text-[14px] whitespace-nowrap">
        <p>
          ...
          <span className="leading-[14px] text-[#2a9d90]">File Uploaded</span>
        </p>
      </div>
    ...
    <div className="relative shrink-0 size-[20px]" data-name="Collaborators Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g id="Collaborators Icon">
          <path clipRule="evenodd" d={svgPaths.p10480470} fill="var(--fill-0, #09090B)" fillRule="evenodd" id="Icon" />
        </g>
      </svg>
    </div>
  );
...
function CreatedByIcon() {
  return (
    <div className="relative shrink-0 size-[20px]" data-name="Created By Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <g clipPath="url(#clip0_1_17054)" id="Created By Icon">
          <path clipRule="evenodd" d={svgPaths.p3760ea20} fill="var(--fill-0, #09090B)" fillRule="evenodd" id="Icon" />
        </g>
        <defs>
...
export default function MultiFileUpload() {
  return (
    <div className="bg-white content-stretch flex flex-col items-start relative size-full" data-name="Multi-file Upload 3">
      <Div />
      <TaskDetails />
      <TaskDetails2 />
    </div>
